...
const inputLanguageDropdown = document.querySelector("#input");
const outputLanguageDropdown = document.querySelector("#output");
...
var languages =[{ no: "0",name: "Auto",native: "Detect",code: "auto", },
...
const outputTextElem=document.querySelector("#outputText");
//const inputlanguage=inputLanguageDropdown.querySelector(".select");
//const outputlanguage=outputLanguageDropdown.querySelector(".select");

function translate() {
    const inputText = inputTextElem.value;
    const inputLanguage =
      inputLanguageDropdown.querySelector(".select").dataset.value;
    const outputLanguage =
      outputLanguageDropdown.querySelector(".select").dataset.value;
